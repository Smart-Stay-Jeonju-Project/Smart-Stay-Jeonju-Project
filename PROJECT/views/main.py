    ...
    try:
        for df in datas :
            ...
            if df:
                ...
                '''
                for row in df: # filtered_df가 아닌 results에 추가
                    row['image'] = get_image_url(row['name'])
                    # rating_score 포맷팅
                    row['rating']
                    # rating_count 포맷팅
                ...
                df['image'] = get_image_url(df['name'])
                # rating_score 포맷팅
                df['rating']
                # rating_count 포맷팅
                '''
                ...
                return render_template(
                    ...
                    accom_list = accom_result['list'],
                    accommodations=df, # accommodations로도 results를 보냅니다.
