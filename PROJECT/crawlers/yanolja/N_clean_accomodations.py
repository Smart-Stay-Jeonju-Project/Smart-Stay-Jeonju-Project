...
saveTargetPath = "crawlers/yanolja/list/"
...
def clean_accommodation(accoms) :
    try :
        ...
        # 평가수 "1,234" -> 1234 정제
        accoms['rating_count'] = accoms['rating_count'].str.replace(',','')
        # 평점 '후기' -> 0
        accoms['rating_score'] = accoms['rating_score'].str.replace('후기','0')
        # 출처 대문자->소문자
        accoms['source'] = accoms['source'].str.replace('N','n')
